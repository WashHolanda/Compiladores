    ...
    case ExpK:
      switch(t->kind.exp){
        ...
        case IdK:
          ...
          break;
        case AtivK:
          if (st_lookup(t->attr.name, escopo) == -1 && strcmp(t->attr.name, "input")!=0 && strcmp(t->attr.name, "output")!=0 && strcmp(t->attr.name, "storePC")!=0 && strcmp(t->attr.name, "storeStack")!=0 && strcmp(t->attr.name, "loadStack")!=0 && strcmp(t->attr.name, "storeRegs")!=0){
